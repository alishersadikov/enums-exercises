...
class AllPatternTest < Minitest::Test
  ...
  def test_all_lies
    ...
    all_lies = false
    lies.each {|lie| all_lies = true unless lie != false }
    assert all_lies
  end
  ...
  def test_all_multiples_of_7
    ...
    numbers.each {|num| all_multiples_of_7 = true unless num % 7 != 0}
  ...
  def test_not_all_3_digits_long
    ...
    all_3_digits = true
    numbers.each {|num| all_3_digits = false unless num.to_s.length == 0}
  ...
  def test_all_4_letter_words
    ...
    all_4_letters = false
    words.each {|word| all_4_letters = true unless word.length != 4 }
